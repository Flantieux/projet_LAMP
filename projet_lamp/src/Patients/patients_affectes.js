...
class Patients_affectes extends Component
{
  ...
  render() {
    return (
      <div className="Patients">
        <header className="Patients_affectes-header">
        <Table dark>
        <thead>
          <tr>
            <th>#</th>
        ...
        <tbody>
          <tr>
            ...
            <th scope="row">1</th>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.id}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.firstname}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.lastname}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.birthday}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.entry_date}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.arrival_date}</div>)}</td>
            <td>{this.state.patients_with_room.map((pat) => <div>{pat.room}</div>)}</td>            
          </tr>
          <tr>
            <th scope="row">2</th>
            <td>A</td>
...
export default Patients_affectes;
